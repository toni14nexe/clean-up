export type CartItem = {
  ...
  image?: string
  size?: string
  menWomenOption?: 'women' | 'men'
  blackWhiteOption?: 'white' | 'black'
  busLine?: string
}
...
export function addToCart(
  ...
  if (existing) {
    ...
    if (product.menWomenOption)
      // @ts-expect-error
      cartItem.menWomenOption = product.menWomenOption
    if (product.blackWhiteOption)
      // @ts-expect-error
      cartItem.blackWhiteOption = product.blackWhiteOption
    if (product.busLine)
      // @ts-expect-error
      cartItem.busLine = product.busLine
