...
const shippingOptions = ref<ShippingOption[]>([
  ...
  /* { label: 'BoxNow', price: getCartTotal() >= 50 ? 0 : 4 },
  { label: 'DPD na adresu', price: getCartTotal() >= 50 ? 0 : 7 } */
])
  ...
  <div class="page-container">
    ...
    <ElRow justify="center" align="middle">
      ...
      >
        ...
        <span
          ><b
            >Za narudžbe u vrijednosti iznad 50,00 eura dostava je besplatna</b
          ></span
        >
        ...
        >
          <ElIcon :size="$viewport.isLessThan('tablet') ? 18 : 22"
            ><ElIconWarningFilled
          /></ElIcon>
          Osobno preuzimanje moguće je na području grada Rijeke, a uskoro ćemo
          vam se javiti radi dogovora o preuzimanju.
        </p>
