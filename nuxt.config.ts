      ...
      meta: [
        {
          name: 's.art',
          content:
            's.art webshop nudi unikatne majice, kreativne motive i dizajnerske proizvode izrađene s ljubavlju i stilom.'
        },
        {
          name: 'keywords',
          content:
            's.art, webshop, majice, dizajn, motivi, umjetnost, pokloni, kreativni proizvodi, ručni rad, hrvatski brend'
        },
